...
2. **Вставьте YouTube URL**, например: `https://youtu.be/dQw4w9WgXcQ`
3. **Нажмите "Получить информацию"** - должна появиться информация о видео
4. **Выберите качество** (720p по умолчанию)
5. **Выберите папку** для сохранения
6. **Нажмите "Скачать видео"**
7. **Проверьте прогресс-бар** и скачанный файл
